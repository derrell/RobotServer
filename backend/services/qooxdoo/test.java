 ...
 * http://qooxdoo.org
 * 
 * Copyright: 2006, 2009, 2010 Derrell Lipman
 * 
...
public class test extends AbstractRpcClass
{
    ...
    public boolean isFloat(float param)
    {
        return true;
    }

    public boolean isFloat(double param)
    {
        return true;
    }
    ...
    @SuppressWarnings("unchecked")
    public JSONArray getParams(Object param1, Object param2)
    {
        JSONArray a = new JSONArray();
        a.add(param1);
        a.add(param2);
    ...
    @SuppressWarnings("unchecked")
    public JSONArray getParams(Object param)
    {
        JSONArray a = new JSONArray();
        a.add(param);
        return a;
